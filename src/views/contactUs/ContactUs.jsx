                                        ...
                                        <div>
                                            ...
                                            <div className="flex flex-col gap-1">
                                                ...
                                                <div className="flex justify-start items-center gap-2">
                                                    ...
                                                    <div className="text-gray-700">
                                                        {formatDateCustom(e?.contactDate)}
                                                    </div>
                                                </div>
            ...
            {dataObj && (
                <div>
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Contact Path: </div>
                            <div className='text-gray-600'>{dataObj?.contactPath || '- -'}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Contact Company: </div>
                            <div className='text-gray-600'>{dataObj?.contactCompany || '- -'}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Contact Reason: </div>
                            <div className='text-gray-600'>{dataObj?.contactReason || '- -'}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Comments: </div>
                            <div className='text-gray-600'>{dataObj?.contactComments || '- -'}</div>
                        </div>

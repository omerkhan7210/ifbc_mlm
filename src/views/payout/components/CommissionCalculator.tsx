    ...
    const calculateCommission = () => {
        ...
        if (isAmbassadorIncluded) {
            commissions.consultant =
                (consultantShare / 100) * amount - shares.ambassadorAmount
        } else {
                    ...
                    <Card className="h-full">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 rounded-2xl my-3 ">
                            <StatisticCard
                                ...
                                value={
                                    commissions.consultant
                                        ? `$${commissions.consultant.toFixed(2)}`
                                        : `${shares?.consultantShare || 0}%`
                                }
                                icon={<BsPersonArmsUp />}
                            />
                            <StatisticCard
                                ...
                                className="bg-slate-100 dark:bg-opacity-75"
                                value={
                                    commissions.seniorConsultant
                                        ? `$${commissions.seniorConsultant.toFixed(2)}`
                                        : `${shares?.seniorConsultantShare || 0}%`
                                }
                                icon={<BsPersonArmsUp />}
                            />
                            <StatisticCard
                                ...
                                value={
                                    commissions?.broker
                                        ? `$${commissions?.broker.toFixed(2)}`
                                        : `${shares?.brokerShare || 0}%`
                                }
                                icon={<BsPersonArmsUp />}
                            />
                            <StatisticCard
                                ...
                                className="bg-slate-100 dark:bg-opacity-75"
                                value={
                                    commissions?.managingBroker
                                        ? `$${commissions?.managingBroker.toFixed(2)}`
                                        : `${shares?.managingBrokerShare || 0}%`
                                }
                                icon={<BsPersonArmsUp />}
                            />
                            {isAmbassadorIncluded && (
                                <StatisticCard
        ...
        >
            <div className=" relative">
                ...
                <div className="flex justify-between items-center">
                    <h6 className="mb-1 text-green-700 text-semibold">
                        {value}
                    </h6>
                    <div
                        className={
            ...
            <div className="text-xs xl:text-sm text-gray-700 space-y-3">
                <div>
                    <p className="font-bold text-blue-700 mb-1">
                        Tier 1: Franchise Consultant
                    </p>
                    <p>
                        <strong>Requirements:</strong> Join the IFBC Network and
                        sell franchises directly.
                    </p>
                    <p>
                        <strong>Earnings:</strong> {shares.consultantShare}%
                        commission on direct franchise sales.
                    </p>
                    <p>
                        <strong>Key Benefits:</strong> Entry-level role focused
                        on personal sales.
                    </p>
                </div>
                <div>
                    <p className="font-bold text-blue-700 mb-1">
                        Tier 2: Senior Franchise Consultant
                    </p>
                    <p>
                        <strong>Requirements:</strong> Build a team of 5
                        Franchise Consultants and achieve 1 direct franchise
                        sale.
                    </p>
                    <p>
                        <strong>Earnings:</strong> {shares.consultantShare}%
                        commission on direct sales and{' '}
                        {shares.seniorConsultantShare}% residual commission on
                        team sales.
                    </p>
                    <p>
                        <strong>Key Benefits:</strong> Unlock the power of
                        team-based residual income.
                    </p>
                </div>
                <div>
                    <p className="font-bold text-blue-700 mb-1">
                        Tier 3: Franchise Broker
                    </p>
                    <p>
                        <strong>Requirements:</strong> Grow a team of 25
                        Franchise Consultants, achieve 3 direct sales or 10 team
                        sales, and promote 1 team member to Senior Franchise
                        Consultant.
                    </p>
                    <p>
                        <strong>Earnings:</strong> {shares.consultantShare}%
                        commission on direct sales,{' '}
                        {shares.seniorConsultantShare}% residual commission from
                        Level 2 team, and {shares.brokerShare}% residual
                        commission from the extended team (Level 3).
                    </p>
                    <p>
                        <strong>Key Benefits:</strong> Develop leadership skills
                        and mentor future leaders.
                    </p>
                </div>
                <div>
                    <p className="font-bold text-blue-700 mb-1">
                        Tier 4: Managing Broker
                    </p>
                    <p>
                        <strong>Requirements:</strong> Build a team of 125
                        Franchise Consultants, achieve 5 direct sales or 20 team
                        sales, and promote 1 team member to Franchise Broker.
                    </p>
                    <p>
                        <strong>Earnings:</strong> {shares.consultantShare}%
                        commission on direct sales,{' '}
                        {shares.seniorConsultantShare}% residual commission from
                        Level 2 team, {shares.brokerShare}% residual commission
                        from Level 3 team, and {shares.managingBrokerShare}%
                        residual commission from subordinate levels.
                    </p>
                    <p>
                        <strong>Key Benefits:</strong> Lead a thriving network,
                        secure long-term residual income, and explore team

                                        ...
                                        <div>
                                            <div className="flex justify-between items-center mb-3">
                                                ...
                                                <div className="bg-green-100 text-green-700 px-2 py-1 font-bold">
                                                    {e?.debtPayments === 'string' ? 'N/A' : e?.debtPayments?.toLocaleString('eng-US')}
                                                </div>
                                            </div>
            ...
            {dataObj && (
                <div>
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Bank Ruptcies: </div>
                            <div className='text-gray-600'>{dataObj?.bankruptcies}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Credit History: </div>
                            <div className='text-gray-600'>{dataObj?.creditHistory}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Credit Score: </div>
                            <div className='text-gray-600'>{dataObj?.creditScore ? dataObj?.creditScore : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Debt payments: </div>
                            <div className='text-gray-600'>{dataObj?.debtPayments ? dataObj?.debtPayments : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Down Payments: </div>
                            <div className='text-gray-600'>{dataObj?.downPayment ? dataObj?.downPayment : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Franchise Location: </div>
                            <div className='text-gray-600'>{dataObj?.franchiseLocation ? dataObj?.franchiseLocation : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>House Hold: </div>
                            <div className='text-gray-600'>{dataObj?.houseHold ? dataObj?.houseHold : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Launching: </div>
                            <div className='text-gray-600'>{dataObj?.launching ? dataObj?.launching : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Percentage: </div>
                            <div className='text-gray-600'>{dataObj?.percentage ? dataObj?.percentage : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Real State: </div>
                            <div className='text-gray-600'>{dataObj?.realState ? dataObj?.realState : "---"}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">

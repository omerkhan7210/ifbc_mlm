...
import { PiEnvelopeThin, PiPhoneCallLight, PiCalendarDotsLight, PiLinkSimpleLight, PiBuildingOfficeThin } from "react-icons/pi";
                ...
                <div>
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex justify-start items-center gap-1">
                            ...
                            <div className='text-gray-600'>{dataObj?.companyName || '- -'}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Company Website: </div>
                            <a href={dataObj?.companyNameUrl} target='_blank'>
                                <div className='text-gray-600 cursor-pointer'>{dataObj?.companyWebsiteUrl || '- -'}</div>
                            </a>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Interested In: </div>
                            <div className='text-gray-600'>{dataObj?.interestedIn || '- -'}</div>
                        </div>
                        <div className="flex justify-start items-center gap-1">
                            <div className='text-gray-800 font-semibold'>Note: </div>
                            <div className='text-gray-600'>{dataObj?.note || '- -'}</div>
                        </div>

...
export const getData = async (endpoint: string, config: object = {}): Promise<any> => {
    try {
...
// @param {object} config - Additional axios config (optional)
// @returns {Promise<object>} - Response data
export const postData = async (endpoint: string, data: object, config: object = {}): Promise<any> => {
    try {
...
// @param {object} config - Additional axios config (optional)
// @returns {Promise<object>} - Response data
export const putData = async (endpoint: string, data: object, config: object = {}): Promise<any> => {
    try {
...
// @param {object} config - Additional axios config (optional)
// @returns {Promise<object>} - Response data
export const deleteData = async (endpoint: string, config: object = {}): Promise<any> => {
    try {
